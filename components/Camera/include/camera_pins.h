...
#define CAMERA_MODEL_ESPDRONE_ESP32S3 // Has 8MB PSRAM OCTAL
//#define CAMERA_MODEL_TTGO_CAMERAPLUS_S3 // Has 8MB PSRAM
...
#elif defined(CAMERA_MODEL_ESPDRONE_ESP32S3)
#define PWDN_GPIO_NUM -1
#define RESET_GPIO_NUM -1
...
#elif defined(CAMERA_MODEL_TTGO_CAMERAPLUS_S3)
#define PWDN_GPIO_NUM -1
